...
public class GenBasic : BaseEntity
{
    ...
    /// 服务代码存放项目
    ///</summary>
    [SugarColumn(ColumnName = "ServicePosition", ColumnDescription = "服务代码存放项目", IsNullable = true, Length = 200)]
    public virtual string ServicePosition { get; set; }

    /// <summary>
    /// 服务代码存放文件夹
    ///</summary>
    [SugarColumn(ColumnName = "ServiceDictionary", ColumnDescription = "服务代码存放文件夹", IsNullable = true, Length = 200)]
    public virtual string ServiceDictionary { get; set; }
    ...
    /// 控制器代码存放文件夹
    ///</summary>
    [SugarColumn(ColumnName = "ControllerDictionary", ColumnDescription = "控制器代码存放文件夹", IsNullable = true, Length = 200)]
    public virtual string ControllerDictionary { get; set; }
