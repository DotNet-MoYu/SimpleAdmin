...
const http = moduleRequest("/biz/organization/role/");
...
/**
 * @Description: 角色管理按钮权限码
 * @Author: huguodong
 * @Date: 2024-02-20 09:51:15
 */
const bizRoleButtonCode = {
  /** 新增角色 */
  add: "bizRoleAdd",
  /** 编辑角色 */
  edit: "bizRoleEdit",
  /** 删除角色 */
  delete: "bizRoleDelete",
  /** 批量删除角色 */
  batchDelete: "bizRoleBatchDelete",
  /** 授权资源 */
  grantResource: "bizRoleGrantResource",
  /** 授权用户 */
  grantUser: "bizRoleGrantUser"
};
export { bizRoleApi, bizRoleButtonCode };
