...
> 这是一个极简的 Geeker-Admin 管理后台。它只包含了 ElementPlus & axios & iconfont & permission control & lint && cz-git && 主题布局切换，这些搭建后台必要的东西。
...
- GitHub：https://gitee.com/zxzyjs/SimpleAdmin/tree/template
...
```text
# GitHub
git clone https://gitee.com/zxzyjs/SimpleAdmin/tree/template
```
